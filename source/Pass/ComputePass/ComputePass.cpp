...
wgpu::Buffer ComputePass::CreateBuffer(uint64_t size, wgpu::BufferUsage usage, bool mapped)
{
...
wgpu::BindGroupLayoutEntry ComputePass::CreateSamplerLayout(uint16_t binding, wgpu::ShaderStage visibility, wgpu::SamplerBindingType type)
{
  wgpu::BindGroupLayoutEntry entry;
  entry.binding = binding;
  entry.visibility = visibility;
...
wgpu::BindGroupLayoutEntry ComputePass::CreateBufferLayout(uint16_t binding, wgpu::ShaderStage visibility, wgpu::BufferBindingType type, uint64_t minBindingSize)
{
  wgpu::BindGroupLayoutEntry entry;
  entry.binding = binding;
  entry.visibility = visibility;
...
wgpu::BindGroupLayout ComputePass::CreateBindGroupLayout(std::vector<wgpu::BindGroupLayoutEntry> entries)
{
...
wgpu::BindGroupEntry ComputePass::CreateBinding(uint16_t entry, wgpu::Sampler& sampler)
{
  wgpu::BindGroupEntry binding = wgpu::Default;
  binding.binding = entry;
...
wgpu::BindGroupEntry ComputePass::CreateBinding(uint16_t entry, wgpu::Buffer& buffer)
{
  wgpu::BindGroupEntry binding = wgpu::Default;
  binding.binding = entry;
...
wgpu::BindGroup ComputePass::CreateBindGroup(std::vector<wgpu::BindGroupEntry> bindings, wgpu::BindGroupLayout& bindLayout)
{
