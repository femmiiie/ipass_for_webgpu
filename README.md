...
1. Create an `ipass::Pipeline` with your `wgpu::Device` and `wgpu::Queue`
2. Load patch data (from a BV file with `ipass::LoadBV` or from your own data)
